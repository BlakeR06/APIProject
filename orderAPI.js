...
receiptPlaceOrderButton.addEventListener('click', function(){
    if(recieptNameInput.value.trim() !== "" && 
       ...
       recieptAddressInput.value.trim() !== ""){
        ...
        alert('Order submitted successfully. We will notify you as soon as possible to schedule your service. Thank you!')
...
function ResetChecks(){
    featuredPackageCheckbox1.checked = false
    featuredPackageCheckbox2.checked = false
    featuredPackageCheckbox3.checked = false
    
    standardPackageCheckbox1.checked = false
    standardPackageCheckbox2.checked = false
    standardPackageCheckbox3.checked = false

    customPackageCheckbox1.checked = false
    customPackageCheckbox2.checked = false
    customPackageCheckbox3.checked = false
    customPackageCheckbox4.checked = false
    customPackageCheckbox5.checked = false
    customPackageCheckbox6.checked = false
    customPackageCheckbox7.checked = false
    customPackageCheckbox8.checked = false
    customPackageCheckbox9.checked = false
    customPackageCheckbox10.checked = false
    customPackageCheckbox11.checked = false
